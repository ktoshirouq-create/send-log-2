document.addEventListener('DOMContentLoaded', () => {
    ...
    const render = () => {
        ...
        charts.grip = new Chart(document.getElementById('gripChart'), {
            ...
            options: { maintainAspectRatio: false, plugins: { legend: { display: false } }, scales: { r: { ticks: { display: false }, grid: { color: '#333' }, angleLines: { color: '#333' }, pointLabels: { font: { size: 10 } } } } }
        });
